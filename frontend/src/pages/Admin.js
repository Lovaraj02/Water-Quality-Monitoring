        ...
        {complaints.map((complaint) => (
          <div key={complaint.id} className="complaint-card">
            ...
            <div className="complaint-btn-box">
              <button className="btn accept" onClick={() => handleAccept(complaint.id)}>Accept</button>
              <button className="btn reject" onClick={() => handleReject(complaint.id)}>Reject</button>
            </div>
