// src/pages/StayAware.js
import React from 'react';
import './App.css';

export default function StayAware(){
  return (
    <div className="container container--narrow stayaware">
      <h1>Stay Aware</h1>

      <div className="about-text">
        <p>Water quality is essential for sustaining life and preserving ecosystems. Here are some key points to stay aware of:</p>

        <h3 className="section-title">Understanding Water Quality</h3>
        <p>Water quality refers to the chemical, physical, biological, and radiological characteristics of water. It affects the health of humans, animals, and plants, as well as the overall ecosystem health.</p>

        <h3 className="section-title">Common Water Pollutants</h3>
        <p>Water pollution can arise from various sources, including industrial discharges, agricultural runoff, sewage discharge, and improper waste disposal. Chemicals, heavy metals, pathogens, and nutrients are among the most common pollutants found in water bodies.</p>

        <h3 className="section-title">Impact of Water Pollution</h3>
        <p>Water pollution can have severe consequences, including contamination of drinking water sources, loss of aquatic biodiversity, degradation of ecosystems, and adverse health effects on humans and wildlife.</p>

        <h3 className="section-title">Protecting Water Quality</h3>
        <p>Individuals can take steps to protect water quality, such as conserving water, reducing pollution, properly disposing of waste, and supporting policies and initiatives that promote clean water and sanitation.</p>

        <h3 className="section-title">Sustainable Development Goal 6</h3>
        <p>Sustainable Development Goal 6 (SDG 6) aims to ensure access to clean water and sanitation for all. By addressing water scarcity, water pollution, and inadequate sanitation facilities, SDG 6 seeks to improve health, reduce poverty, and promote sustainable development globally.</p>
      </div>
    </div>
  );
}
